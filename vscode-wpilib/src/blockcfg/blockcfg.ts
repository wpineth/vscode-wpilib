...
import { BlockCfgEditorProvider } from './blockcfgeditor';
...
export async function activateBlockCfg(context: vscode.ExtensionContext, _: IExternalAPI) {
    context.subscriptions.push(BlockCfgEditorProvider.register(context));
