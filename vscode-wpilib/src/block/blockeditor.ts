...
export class BlockEditorProvider implements vscode.CustomTextEditorProvider {
	 ...
	 */
	private getHtmlForWebview(_: vscode.Webview): string {
		// Local path to script and css for the webview
		// const scriptUri = webview.asWebviewUri(vscode.Uri.joinPath(
		// 	this.context.extensionUri, 'vscode-wpilib/resources/webviews', 'test.html'));
	...
	// 	const character = BlockEditorProvider.scratchCharacters[Math.floor(Math.random() * BlockEditorProvider.scratchCharacters.length)];
	// 	json.scratches = [
